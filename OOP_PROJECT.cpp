...
{
    //string rollNumber, firstName,lastName; 
    string standard;
...
public:
    ...
    //checks if student exists in the stadard or not
    ...
    void operator=(tuple<string, string> info);
};
...
void admin::listStand() //lists the name of standards created in "Standard folder"
{
    ...
    cout<<endl<<"Enter -1 to go back to the menu";
    cout << "\nEnter S.No of a standard to view its details: ";
    int choice;
    cin>>choice;
    if (choice==-1) return;
